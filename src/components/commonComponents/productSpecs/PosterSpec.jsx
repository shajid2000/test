...
const PosterSpec = () => {
  ...
  const lan = ["", "English", "Hindi", "Bilinguale", "Marthi"];
...
let dummy = ["Description Coming Soon"]
  useEffect(() => {
    ...
    const getSpecificationData = async () => {
      ...
      if (response) {
        setLangVariant(response.data.langVariant);
        ...
        setMat({
          ...
          details: response.data.posterDetails[0].description?response.data.posterDetails[0].description.split("|"):dummy,
          activeDetail: response.data.posterDetails[0].description?response.data.posterDetails[0].description.split("|"):dummy
          // .filter((elem, i) => {
          //   return i > 5;
          // }),
        });
  ...
  const setActiveDetail = (i) => {
    ...
    //   });
    // }
    return mat.materials[i].description.split("|");
  };
      ...
      <>
        ...
        <div className="productSpec">
          <div className="productImg">
            {console.log(specification, "poster")}
            ...
            <div id="detailOfProductSmall">
              ...
              <div className="productRating">
                ...
                <span className="availability">In Stoock</span>
              </div>
          ...
          <div className="productConfig">
            ...
            <div className="lan">
{
  langVariant !== undefined && langVariant.map((e)=>{
    return productId!=e._id &&   <Link key={e._id}
    to={`/posterspecification/${e._id}`}
    className="bsLink"
  ><button
   onClick={()=>{
    setLoading(true)
   ...
   className="lanLI">{lan[e.language]}</button></Link>
  })
}
            </div>
>>>>>>> c19f0c407ff7d72dc352c5c6368eded1cf78ba3d
